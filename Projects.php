...
echo "		$('#urlPath').attr('value', 'ProjectsBody.html');	";
...
<li class="item-108 current active">
...
echo '<input type="hidden" id="urlPath" name="urlPath" value="ProjectsBody.html"></input>';
echo '<div id="contentArea" name="contentArea" class="noteditable" contenteditable="false">';
include ("ProjectsBody.html");
echo '</div>';
