...
echo "		$('#urlPath').attr('value', 'Lab-MembersBody.html');	";
...
echo '<input type="hidden" id="urlPath" name="urlPath" value="Lab-MembersBody.html"></input>';
echo '<div id="contentArea" name="contentArea" class="noteditable" contenteditable="false">';
include ("Lab-MembersBody.html");
echo '</div>';
