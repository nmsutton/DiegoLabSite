...
echo "		$('#urlPath').attr('value', 'PublicationsBody.html');	";
...
echo '<input type="hidden" id="urlPath" name="urlPath" value="PublicationsBody.html"></input>';
echo '<div id="contentArea" name="contentArea" class="noteditable" contenteditable="false">';
include ("PublicationsBody.html");
echo '</div>';
