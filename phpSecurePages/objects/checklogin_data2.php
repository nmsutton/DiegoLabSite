...
<form action='/NewSite/Welcome.php' method='post' name='loginForm'>
<?php
...
echo "<input type='hidden' name='authenticationCorrect' value='true'>";
	...
	setcookie("login", $login, time()+1200, "http://diego.asu.edu/","", 0);
	setcookie("password", $password, time()+1200, "http://diego.asu.edu/","", 0);
	setcookie("authenticationCorrect", "true", time()+1200, "http://diego.asu.edu/","", 0);
?>
</form>
