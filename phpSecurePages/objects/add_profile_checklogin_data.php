...
//header:("Location:http://localhost/xampp/DiegoLabSite/DiegoLabSite/Welcome%20to%20the%20D.I.E.G.O.%20Lab.php");
?>

<form action='http://localhost/xampp/DiegoLabSite/DiegoLabSite/uploadFiles.php' method='post' name='loginForm'>
<?php
...
echo "<input type='hidden' name='authenticationCorrect' value='true'>";
	...
	echo $_COOKIE['login'];
	echo "<br>authCorr: ";
	echo $_COOKIE['authenticationCorrect'];
?>
</form>
...
alert('test');
window.location.assign('addUserProfilePage.php');
